...
add_action( 'tgmpa_register', 'icos_register_required_plugins' );
function icos_register_required_plugins() {
    $protocol = is_ssl() ? 'http' : 'http';
    $plugins = array(
        // This is an example of how to include a plugin from the WordPress Plugin Repository.      
        array(
            'name'               => esc_html__( 'Meta Box', 'icos' ),
            'slug'               => 'meta-box',
            'required'           => true,
        ...
        array(            
            'name'               => esc_html__( 'Kirki Customizer', 'icos' ), // The plugin name.
            'slug'               => 'kirki', // The plugin slug (typically the folder name).
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
        array(
            'name'               => esc_html__( 'MailChimp for WordPress', 'icos' ),
            'slug'               => 'mailchimp-for-wp',
            'required'           => false,
        ),
        array(
            'name'               => esc_html__( 'Contact Form 7', 'icos' ),
            'slug'               => 'contact-form-7',
            'required'           => false,
        ),
        array(            
            'name'               => esc_html__( 'WPBakery Visual Composer', 'icos' ), // The plugin name.
            'slug'               => 'js_composer', // The plugin slug (typically the folder name).
            'source'             => esc_url($protocol.'://oceanthemes.net/plugins-required/js_composer.zip'), // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
        array(            
            'name'               => esc_html__( 'OT Team', 'icos' ), // The plugin name.
        ...
        array(            
            'name'               => esc_html__( 'OT One Click Demo Content', 'icos' ), // The plugin name.
